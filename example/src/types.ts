...
export type ExampleProps = TimelineProps<TimelineEventId, TimelineLaneId>
export type ExampleComponentFactory = EventComponentFactory<TimelineEventId, TimelineLaneId>
